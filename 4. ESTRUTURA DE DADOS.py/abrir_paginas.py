...
def abrir_whatsapp():
    ...
    subprocess.Popen(['start', 'chrome', '--incognito', 'https://web.whatsapp.com'])

def abrir_email():
    # Abrir email em uma janela normal
    subprocess.Popen(['start', 'chrome', 'https://mail.google.com'])

def abrir_github():
    # Abrir GitHub em uma janela normal
    subprocess.Popen(['start', 'chrome', 'https://github.com'])
